...
def main():
    ...
    nd = xr.open_dataset(
        "~/Data/CCCA/rsds_SDM_ICHEC-EC-EARTH_rcp45_r1i1p1_KNMI-RACMO22E.nc"
    )
    ...
    for index, point in rspoints.iterrows():
        ...
        print("point: {} - xy: {},{}".format(point.geometry, nx, ny))
        ...
        for year, daterange in dates365.items():
            ...
            for ghi in rsdsvalues:
                ...
                print(mean_yearly_sum)
                y_mean = mean_yearly_sum / 1000
